...
public interface AppointmentRepository extends JpaRepository<AppointmentEntity, Long>, JpaSpecificationExecutor<AppointmentEntity> {
    ...
    List<AppointmentEntity> findByClientAndStatus(User client, Status status);
    
    Optional<AppointmentEntity> findByClientAndStartDateTime(User client, LocalDateTime startDateTime);
}
